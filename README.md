...
Our pre-trained model for drug synergy prediction is available for download([https://zenodo.org/records/17888472](https://doi.org/10.5281/zenodo.18830842)). Please save it in the `save_model/`directory.
