    ...
    if args.mode == 'train':
        ...
        for k in nfold:
            ...
            for epoch in range(start_epoch, args.epochs):
                ...
                val_loss, _, _, _, _, _, _,_,_ = validate(model=model,criterion=criterion,dataloader=val_dataloader,device=device,args=args)
            ...
            m1,m2,m3,m4,m5,m6,m7,_,_ = validate(model=model,criterion=criterion,dataloader=tr_dataloader,device=device,args=args)
            mse, rmse, mae, r2, pearson, spearman,_,_,_ = validate(model=model,criterion=criterion,dataloader=val_dataloader,device=device,args=args)
        ...
        tr_dataloader , val_dataloader, test_dataloader = load_dataloader(n_fold=k,args=args)
        mse, rmse, mae, r2, pearson, spearman,_,y_true, y_pred = validate(model=model,criterion=criterion,dataloader=test_dataloader,device=device,args=args)
        ...
        csv_path = f"pred_vs_true_synergy_score.csv"
